...
Since we are interested in analyzing the average reviews stars by State. We use 2 collumns of available business.avg.stars and review_count grouped by state for analyzing. As below, we can get sense by looking by the first 10 rows.

```{r}
joined_data= joined_data %>% left_join(data_bs, by="business_id")
